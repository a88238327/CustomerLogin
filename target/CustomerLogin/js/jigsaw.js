(function(window){const l=42,r=10,w=310,h=155,PI=Math.PI
const L=l+r*2
...
this.slider.addEventListener('touchstart',function(e){console.log('touchstart');console.log(e);originX=e.targetTouches[0].pageX,originY=e.targetTouches[0].pageY;console.log(originX);console.log(originY);isTouchStart=true})
document.addEventListener('touchmove',(e)=>{if(!isTouchStart)return false
...
trail.push(moveY)})
document.addEventListener('touchend',(e)=>{console.log('touched');console.log(e);if(!isTouchStart)return false
isTouchStart=false
...
setTimeout(()=>{this.reset()},10)}else{addClass(this.sliderContainer,'sliderContainer_fail')
