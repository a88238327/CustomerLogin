...
$(function () {
    var mPickerDefaults = {
        ...
        splitStr: ' ',
        isshort: false,
        header: '<div class="mPicker-footer"><a href="javascript:;" class="mPicker-confirm">确定</a><a href="javascript:;" class="mPicker-cancel">取消</a></div>',
    ...
    MPicker.prototype = {
        ...
        confirm: function () {
            ...
            $.each($listUl, function (index, ele) {
                ...
                if ($active.length > 0) {
                    index = index + 1;
                    self.container.data('value' + 2, $active.data('value'));
                    self.container.data('id' + 2, $active.data('id'));
                    str = $active.text();
                }
            });
...
$('#city').mPicker({
    ...
    header: '<div class="mPicker-footer"><a href="javascript:;" class="mPicker-confirm">确定</a><a href="javascript:;" class="mPicker-cancel">取消</a></div>',
    confirm: function () {
        getLocation.getLocation($('#city').val());
        //更新json
        //console.log($('.select-value').data('value2'));
        //this.container.data('mPicker').updateData(level2);
        // console.info($('.select-value').data('name1')+'-'+$('.select-value').data('value2'));
    },
    cancel: function () {
